    ...
    <div class="container">
      <div class="input-form-backgroud row">
        <div class="input-form col-md-12 mx-auto">
          ...
          <form class="validation-form" action="member/joinMember.do" method="post" >
            <div class="row">
             ...
             <div class="mb-3">
	            ...
	            <div class="mb-4 text-center">
	              ...
	              <input class="btn btn-primary btn-lg btn-block" type ="reset" value="취소" onclick='location.href="index.jsp";'>
	            </div>
	        </div>           
          </form>
        </div>
