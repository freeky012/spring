            ...
            <div class="container-fluid ">
              <ul class="navbar-nav" >
                <li class="nav-item px-3">
                  <a class="nav-link active text-white" href="index.do">홈</a>
                </li>
                <li class="nav-item px-3">
                  <a class="nav-link text-white" href="member/listMember.do">회원목록</a>
                </li>
                <li class="nav-item px-3">
                  <a class="nav-link text-white" href="index.jsp?pageinfo=listBbs.jsp">게시판</a>
                </li>
                <li class="nav-item px-3">
                  <a class="nav-link text-white" href="index.jsp?pageinfo=listNotebook.jsp">노트북목록</a>
                </li>
              </ul>
		  ...
		  <c:choose> 
			  <c:when test="${not empty sessionScope.id}">
		                      ...
		                      <ul class="dropdown-menu">
		                        ...
		                        <li><a class="dropdown-item" href="index.jsp?pageinfo=payReservation.jsp">장바구니</a></li>
